...
<body class="bg-light d-flex align-items-center justify-content-center vh-100">
    <div class="card p-4 shadow-sm border-0" style="width: 100%; max-width: 400px; border-radius: 12px;">
        ...
        <form action="<?= $baseUrl ?>/Auth/storeUser" method="POST" autocomplete="off">
            <div class="mb-3">
            ...
            <div class="mt-3 text-center">
                <span class="small text-muted">Sudah punya akun? <a href="<?= $baseUrl ?>/Auth/login" class="text-primary fw-bold text-decoration-none">Login di sini</a></span>
            </div>
        </form>
    </div>
</body>
